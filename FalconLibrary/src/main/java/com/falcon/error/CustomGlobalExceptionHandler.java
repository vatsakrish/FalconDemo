...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * status code
	 * 
	 * @ExceptionHandler(AuthorNotFoundException.class) public void
	 * springHandleNotFound(HttpServletResponse response) throws IOException {
	 * response.sendError(HttpStatus.NOT_FOUND.value()); }
	 * 
	 * @ExceptionHandler(AuthorUnSupportedFieldPatchException.class) public void
	 * springUnSupportedFieldPatch(HttpServletResponse response) throws IOException
